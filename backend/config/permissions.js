...
const ROLE_NAMES = {
  VILLAGE_CHIEF: process.env.ROLE_NAME_VILLAGE_CHIEF || 'Village Chief',
  VILLAGE_ELDER: process.env.ROLE_NAME_VILLAGE_ELDER || 'Village Elder',
  VILLAGE_GUARDIAN: process.env.ROLE_NAME_VILLAGE_GUARDIAN || 'Village Guardian',
};

const ROLE_CAPABILITIES = {
  [ROLE_NAMES.VILLAGE_CHIEF]: [
  ...
  [ROLE_NAMES.VILLAGE_ELDER]: [
    CAPABILITIES.MODERATE_WARN, CAPABILITIES.MODERATE_MUTE,
    CAPABILITIES.EVENTS_CREATE, CAPABILITIES.EVENTS_DELETE, CAPABILITIES.DASHBOARD_VIEW,
  ],
  [ROLE_NAMES.VILLAGE_GUARDIAN]: [
    CAPABILITIES.MODERATE_WARN, CAPABILITIES.MODERATE_MUTE, CAPABILITIES.MODERATE_KICK,
